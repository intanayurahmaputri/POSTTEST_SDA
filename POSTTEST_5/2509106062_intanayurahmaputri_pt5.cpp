...
Kamu diminta membuat fungsi untuk menampilkan daftar barang sembako beserta stoknya yang tersimpan dalam struktur data Circular Linked List.
Berbeda dengan linked list biasa, pada Circular Linked List, pointer `next` dari node terakhir tidak menunjuk ke `nullptr`, melainkan kembali menunjuk ke node `head`. 
...
// Implementasi fungsi tampilkanStokSembako
...
/*
- PENJELASAN IMPLEMENTASI FITUR TAMPILKAN STOK SEMBAKO:
    Fungsi tampilkanStokSembako menampilkan seluruh data pada circular linked list.
    Jika head bernilai nullptr, maka ditampilkan pesan bahwa data kosong. Jika tidak,
    traversal dilakukan menggunakan do-while mulai dari head, mencetak setiap node,
    dan berhenti saat kembali ke head sehingga tidak terjadi infinite loop.
*/
